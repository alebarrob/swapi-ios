...
class PersistenceController {
    ...
    private func insertInitialData() {
        container.performBackgroundTask { backgroundContext in
            ...
            let mandarins = FoodEntity(context: backgroundContext)
            mandarins.id = 9
            mandarins.name = "Mandarinas"
            mandarins.standardAmount = 170.0
            mandarins.category = fruits
            mandarins.unit = grams
            ...
            let serranoHam = FoodEntity(context: backgroundContext)
            serranoHam.id = 32
            serranoHam.name = "Jamón serrano"
            serranoHam.standardAmount = 45.0
            serranoHam.category = fatsAndProteins
            serranoHam.unit = grams
            ...
            let curedPorkLoin = FoodEntity(context: backgroundContext)
            curedPorkLoin.id = 34
            curedPorkLoin.name = "Lomo embuchado"
            curedPorkLoin.standardAmount = 50.0
            curedPorkLoin.category = fatsAndProteins
            curedPorkLoin.unit = grams
            ...
            let riceOrCornCakes = FoodEntity(context: backgroundContext)
            riceOrCornCakes.id = 67
            riceOrCornCakes.name = "Tortitas de arroz o maíz"
            riceOrCornCakes.standardAmount = 3.0
            riceOrCornCakes.category = carbohydrates
            riceOrCornCakes.unit = units
